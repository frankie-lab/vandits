...
![VANDITS Logo](https://img.shields.io/badge/VANDITS-v1.6.2-blue?style=for-the-badge)
...
### v1.6.2 (2026-05-25)
- PR-IMPORT-UX-4: sub-toggle Accion/Historico por tab + CTA real en PanelFooter elevada desde el hijo via hidePrimaryCta + onPrimaryStateChange. Footer canonico no decorativo, sin CTA duplicada inline. Historico con CTA secundaria 'Nueva importacion'. Tooltips en disabled. No tocados parsers/scrapers/edge/schema/RLS.

### v1.6.1 (2026-05-25)
- PR-IMPORT-UX-3 — Panel "Fuentes de importación": 3 tabs operativas (Archivos · Web · Imágenes), wizard PR-IMPORT-UX-2 retirado, histórico contextual por fuente.
...
### v1.5.15 (2026-05-25)
- PR-IMPORT-UX-1: hub de importación unificado (3 vías canónicas: Archivos · Web · OneDrive · fotos) + Biblioteca, audit operability, contract test.

### v1.5.14 (2026-05-25)
- PR-BOOT-PERF-2: concurrent catalog pagination (window 3) + contract test

### v1.5.13 (2026-05-25)
- PR-BOOT-PERF-1 closure: after-PR1 dossier + boot-gate contract test

### v1.5.12 (2026-05-25)
- PR-BOOT-PERF-1: defer batch-enrich storm + boot-gate + getActive concurrency limit

### v1.5.11 (2026-05-25)
- PR-AUTH-BLANK-1 — shared auth state + root redirect fallback

### v1.5.10 (2026-05-25)
- PR-EXPORT-8: GuruMaps full popup content — sin truncado, ficha completa

### v1.5.9 (2026-05-25)
- PR-EXPORT-7: GuruMaps simplification — drop links/hashtags, add collection, expand description

### v1.5.8 (2026-05-24)
- PR-EXPORT-6 GuruMaps target renderer

### v1.5.7 (2026-05-24)
- PR-EXPORT-5 — Export Content Model & Popup Parity (layers + KML HTML + CSV/JSON/GeoJSON enrichment)

### v1.5.6 (2026-05-24)
- PR-EXPORT-4 — Semántica internal vs public en ExportResolver (copy + contadores scope-aware, sin No incluidos genérico)
...
### v1.5.3 (2026-05-24)
- PR-EXPORT-DISCOVERY-1 docs/contracts/poi-export-canon.md

### v1.5.2 (2026-05-24)
- Mantener: oculta fila A/B/C/D del FilterBar y añade universo 'user-action' (solo A+C requieren intervención humana). Footer Resolver pendiente de rediseño (PR siguiente).
