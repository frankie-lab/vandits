...
1.x — Producto funcional
  ...
  1.5.16        PR-IMPORT-UX-1 closure: OneDrive sub-tabs split into Importar/Avanzado, DocumentsPanel marked as Biblioteca, import canon docs + memory synchronized, backlog explicit  ← versión actual (stable / current)
