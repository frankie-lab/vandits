...
1.x — Producto funcional
  ...
  1.5.15        PR-IMPORT-UX-1: hub de importación unificado (3 vías canónicas: Archivos · Web · OneDrive · fotos) + Biblioteca, audit operability, contract test.  ← versión actual (stable / current)
