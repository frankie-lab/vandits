...
1.x — Producto funcional
  ...
  1.5.2        Mantener: oculta fila A/B/C/D del FilterBar y añade universo 'user-action' (solo A+C requieren intervención humana). Footer Resolver pendiente de rediseño (PR siguiente).  ← versión actual (stable / current)
