...
1.x — Producto funcional
  ...
  1.6.1        PR-IMPORT-UX-3 — Panel "Fuentes de importación": 3 tabs operativas (Archivos · Web · Imágenes), wizard PR-IMPORT-UX-2 retirado, histórico contextual por fuente.  ← versión actual (stable / current)
