...
1.x — Producto funcional
  ...
  1.5.5        PR-EXPORT-3 fix · Eliminar typed-token EXPORTAR y threshold local del EffectiveActionFooter; export delega 100% en ExportResolver  ← versión actual (stable / current)
