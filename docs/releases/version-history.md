...
1.x — Producto funcional
  ...
  1.5.1        PR-MAINTAIN-FOOTER-1: Mantener footer primary = Resolver (nunca Exportar); 1 POI abre popup canónico, N POIs abre HealthRepairPreviewDialog; Exportar demoted a menú  ← versión actual (stable / current)
