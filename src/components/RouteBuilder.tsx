...
import { useRoutes, RouteWaypoint, Route } from '@/domains/routes';
import { useRouteCalculation } from '@/domains/routes';
import { useRouteStops } from '@/domains/routes';
    ...
    <div className="flex flex-col h-full">
      ...
      <ScrollArea className="flex-1">
        <div className="px-3 pt-3 space-y-3">
          ...
          {/* Segment breakdown — rendered between origin/waypoints and destination */}
          {loadingEdit && (
            ...
            return inlineInsertIndex === insertIdx + 1 ? (
              ...
              <div className="flex justify-center py-0.5">
                <button
                  ...
                  className="flex items-center justify-center w-5 h-5 rounded-full border border-dashed border-muted-foreground/40 text-muted-foreground/60 hover:border-primary hover:text-primary hover:bg-primary/10 transition-colors"
                  title="Añadir punto intermedio antes del destino"
                >
                  <Plus className="w-3 h-3" />
                </button>
              </div>
