...
` : '';
  ...
  if (enriched) {
    ...
    return `
<div id="${popupId}" style="min-width: ${CARD.minWidth}px; max-width: ${CARD.maxWidth}px; max-height: calc(100vh - 180px); overflow-y: auto; font-family: ${CARD_FONT_FAMILY}; position: relative;">
${statusBarHtml}
