...
const DEFAULTS: MarkerSizeMap = {
  ...
  followed: { base_normal: 12, base_selected: 16, base_focused: 18, base_recent: 20, hover_normal: 24, hover_selected: 28, hover_focused: 30, hover_recent: 32, marker_shape: 'circle' },
