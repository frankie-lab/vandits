...
export function PoiPreview({
  ...
  // Health rings render in compact/standard/rich (canon: createCustomIcon
  // skipHealthRings only on micro). Stories must reflect that.
  const ringsAllowed = renderMode !== 'micro';
